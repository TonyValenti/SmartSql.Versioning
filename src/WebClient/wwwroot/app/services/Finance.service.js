    ...
    return {
        ...
        execute: function() {
            FinanceSvc = (function () {
                 ...
                 * @returns
                 */
                FinanceSvc.prototype.addFinancial = function (entId, financial) {
                ...
                /**
                  ...
                  * @returns
                  */
                FinanceSvc.prototype.updateFinancial = function (insId, financial) {
                    var body = JSON.stringify({
                ...
                * @returns
                */
                FinanceSvc.prototype.archiveFinancial = function (instId) {
                    var body = JSON.stringify({
                ...
                FinanceSvc.prototype.logAndPassOn = function (error) {
                    // in a real world app, we may send the server to some remote logging infrastructure
                    // instead of just logging it to the console
                    console.error(error);
                    return Observable_1.Observable.throw(error);
                };
                FinanceSvc = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], FinanceSvc);
                return FinanceSvc;
            })();
            exports_1("FinanceSvc", FinanceSvc);
        }
    }
});
